    ...
    <div id="kt_header" class="header">
        ...
        <div class="container d-flex align-items-center justify-content-between" id="kt_header_container">
            ...
            <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-5 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
                <!--begin::Heading-->
                <h1 class="d-flex flex-column text-dark fw-bolder my-0 fs-1">Contact Message</h1>
                <!--end::Heading-->
                <!--begin::Breadcrumb-->
            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder fs-3 mb-1">Contact Message</span>
                    </h3>
                </div>
                <!--end::Header-->
                <!--begin::Body-->
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="d-flex justify-content-start flex-column">
                                                    <p class="text-dark fw-bolder mb-1 fs-6">{{$contact->name}}</p>
                                                    <p class="text-muted fw-bold text-muted d-block fs-7">
                                                    <span class="text-dark">Email</span>: {{$contact->email}}</p>
                                                </div>
                                                <!--end::Name-->
                                            </div>
                                        </td>
