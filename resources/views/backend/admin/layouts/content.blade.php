                ...
                <div  class="d-flex align-items-center ms-3 ms-lg-4">
                    ...
                    <div class="btn btn-icon btn-color-gray-700 btn-active-color-primary btn-outline btn-outline-secondary w-40px h-40px position-relative" id="kt_drawer_chat_toggle">
                        ...
                        @if ($postmessages->count() != 0)
                            <!--begin::Bullet-->
                            <span class="badge badge-danger badge-counter position-absolute translate-middle top-0 start-50 animation-blink">{{$postmessages->count()}}</span>
                            <!--end::Bullet-->
                        @endif
                    </div>
                    <!--end::Drawer wrapper-->
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="container-xxl" id="kt_content_container">
            ...
            <div class="row g-5 g-xl-8">
                ...
                <div class="col-xl-3 col-md-4">
                    <!--begin::Statistics Widget 5-->
                    <a href="{{route('posts.index')}}" class="card bg-info hoverable card-xl-stretch mb-5 mb-xl-8">
                        <!--begin::Body-->
                        <div class="card-body">
                            ...
                            <div class="text-white fw-bolder fs-2 mb-2 mt-5">
                                <div id="post-count" data-max-number="{{App\Models\Post::all()->count()}}">
                                    0
                                </div>
                            </div>
                            <div class="fw-bold text-white">Total Post</div>
                        </div>
                        <!--end::Body-->
                    </a>
                    <!--end::Statistics Widget 5-->
                ...
                <div class="col-xl-3 col-md-4">
                    <!--begin::Statistics Widget 5-->
                    <a href="{{route('pending.index')}}" class="card bg-body hoverable card-xl-stretch mb-xl-8">
                        <!--begin::Body-->
                        <div class="card-body">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen032.svg-->
                            <span class="svg-icon svg-icon-primary svg-icon-3x ms-n1">
                            ...
                            <!--end::Svg Icon-->
                            <div class="text-gray-900 fw-bolder fs-2 mb-2 mt-5">
                                <div id="pending-count" data-max-number="{{App\Models\Post::where('status',0)->get()->count()}}">
                                    0
                                </div>
                            </div>
                            <div class="fw-bold text-gray-400">
                ...
                <div class="col-xl-3 col-md-4">
                    <!--begin::Statistics Widget 5-->
                    <a href="{{route('categorys.create')}}" class="card bg-warning hoverable card-xl-stretch mb-xl-8">
                        <!--begin::Body-->
                        <div class="card-body">
                            <!--begin::Svg Icon | path: icons/duotune/finance/fin006.svg-->
                            <span class="svg-icon svg-icon-white svg-icon-3x ms-n1">
                            ...
                            <!--end::Svg Icon-->
                            <div class="text-gray-100 fw-bolder fs-2 mb-2 mt-5">
                                <div id="category-count" data-max-number="{{App\Models\Category::all()->count()}}">
                                    0
                                </div>
                            </div>
                            <div class="fw-bold text-gray-100">Category</div>
                        </div>
                        <!--end::Body-->
                    </a>
                    <!--end::Statistics Widget 5-->
                ...
                <div class="col-xl-3 col-md-4">
                    <!--begin::Statistics Widget 5-->
                    <a href="{{route('advertisements.index')}}" class="card bg-dark hoverable card-xl-stretch mb-xl-8">
                        <!--begin::Body-->
                        <div class="card-body">
                            <!--begin::Svg Icon | path: icons/duotune/ecommerce/ecm008.svg-->
                            <span class="svg-icon svg-icon-gray-100 svg-icon-3x ms-n1">
                            ...
                            <!--end::Svg Icon-->
                            <div class="text-gray-100 fw-bolder fs-2 mb-2 mt-5">
                                <div id="ads-count" data-max-number="{{App\Models\Advertisement::all()->count()}}">
                                    0
                                </div>
                            </div>
                            <div class="fw-bold text-gray-100">Advertisement</div>
                        </div>
                        <!--end::Body-->
                    </a>
                    <!--end::Statistics Widget 5-->
...
<script>
    ...
    new numberRush('post-count', {
        speed: 50,
    });
    new numberRush('pending-count', {
        speed: 50,
    });
    new numberRush('category-count', {
        speed: 50,
    });
    new numberRush('ads-count', {
        speed: 50,
    });
</script>
