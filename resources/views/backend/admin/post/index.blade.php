                        ...
                        <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4" id="post-table">
                            ...
                            <thead>
                                <tr class="fw-bolder text-muted bg-light">
                                    <th class="ps-4 min-w-300px rounded-start">Title</th>
                                    <th class="min-w-80px text-end">Category</th>
                                    <th class="min-w-80px text-end">Date</th>
                                    <th class="min-w-80px text-end">Status</th>
                                    <th class="min-w-110px text-end">Action</th>
                                </tr>
                            </thead>
                            <!--end::Table head-->
                            <!--begin::Table body-->
                                ...
                                @forelse ($posts as $key=>$post)
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="d-flex justify-content-start flex-column">
                                                    <p class="text-dark fw-bolder mb-1 fs-6">{!! (Str::limit($post->title,30)) !!}</p>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <a href="{{route('posts.edit',[$post->id,$post->slug])}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="edit">
