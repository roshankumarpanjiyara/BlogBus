...
<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="container-xxl" id="kt_content_container">
            <form class="form" action="{{route('advertisements.update',[$ad->id])}}" method="post" enctype="multipart/form-data">@csrf
                {{method_field('PATCH')}}
                <!--begin::Stats-->
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body text-center pt-0">
                                    ...
                                    <div class="image-input image-input-empty image-input-outline mb-3" data-kt-image-input="true" style="background-image: url(template/assets/media/svg/files/blank-image.svg)">
                                        ...
                                        <div class="image-input-wrapper w-350px h-200px"  style="background-image: url({{asset($ad->image) }})"></div>
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <!--end::Label-->
                                    <input type="text" name="link" class="form-control @error('link') is-invalid @enderror" autocomplete="off" placeholder="Ad link" value="{{$ad->link}}">
                                    @error('link')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    ...
                                    <select class="form-select form-select-solid @error('type') is-invalid @enderror" data-control="select2" data-hide-search="true" data-placeholder="Select a Type" name="type">
                                        @if ($ad->type==1)
                                            <option value="1" selected hidden>Vertical Ads</option>
                                        @else
                                            <option value="2" selected hidden>Horizontal Ads</option>
                                        @endif
