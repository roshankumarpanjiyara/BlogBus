    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="row g-5 g-xl-8">
                <div class="col-xl-3 col-md-4">
                    ...
                    <a href="{{route("userposts.index")}}" class="card bg-body hoverable card-xl-stretch mb-xl-8">
                        <!--begin::Body-->
                        <div class="card-body">
                            ...
                            <div class="text-gray-900 fw-bolder fs-2 mb-2 mt-5">
                                <div id="total-post-count" data-max-number="{{App\Models\Post::where('username',auth()->user()->username)->get()->count()}}">
                                    0
                                </div>
                            </div>
                ...
                <div class="col-xl-3 col-md-4">
                    <!--begin::Statistics Widget 5-->
                    <a href="{{route("userposts.index")}}" class="card bg-dark hoverable card-xl-stretch mb-xl-8">
                        <!--begin::Body-->
                        <div class="card-body">
                            ...
                            <div class="text-gray-100 fw-bolder fs-2 mb-2 mt-5">
                                <div id="approved-post-count" data-max-number="{{App\Models\Post::where('username',auth()->user()->username)->where('status',1)->get()->count()}}">
                                    0
                                </div>
                            </div>
                            <div class="fw-bold text-gray-100">Approved Post</div>
                        </div>
                        <!--end::Body-->
                    </a>
                    <!--end::Statistics Widget 5-->
                    ...
                    <a href="#" class="card bg-warning hoverable card-xl-stretch mb-xl-8">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-white fw-bolder fs-2 mb-2 mt-5">
                                <div id="comment-count" data-max-number="{{App\Models\Comment::where('username',auth()->user()->username)->get()->count()}}">
                                    0
                                </div>
                            </div>
                            <div class="fw-bold text-white">Coments</div>
                        </div>
                        <!--end::Body-->
                    </a>
                    <!--end::Statistics Widget 5-->
...
<script>
    new numberRush('total-post-count', {
        speed: 50,
    });
    new numberRush('approved-post-count', {
        speed: 50,
    });
    new numberRush('comment-count', {
        speed: 50,
    });
</script>
